              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $dt->id; ?>">
                      ...
                      <td><?php if($dt->type == "category") { echo $dt->cat_title; }else{ echo $dt->type_value; } ?></td>
                      <td><div class="cat-img" style="width: 50px; height: 50px;"><img width="100%" height="100%" src="<?php echo base_url('uploads/banners/crop/small/'.$dt->image); ?>" /></div></td>
                      <td>
                        <div class="btn-group">
