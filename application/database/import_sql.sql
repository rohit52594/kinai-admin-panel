...
CREATE TABLE `address` (
  ...
  `delivery_landmark` longtext NOT NULL,
  `delivery_fullname` varchar(255) NOT NULL,
  `delivery_mobilenumber` varchar(15) NOT NULL,
...
(26, 'email_id', 'arity.php@gmail.com', 'site_settings', 1),
(27, 'fcm_topic', 'Serv_Pro', 'site_settings', 1),
(28, 'email_sender', 'arity.php@gmail.com', 'site_settings', 1),
(29, 'per_day_appointment', '10', 'site_settings', 1),
(30, 'email_provider', 'smtp_mail', 'email_settings', 1),
(31, 'php_mail', '', 'email_settings', 1),
(32, 'smtp_crypto', 'tls', 'email_settings', 1),
(33, 'smtp_host', 'smtp.gmail.com', 'email_settings', 1),
(34, 'smtp_port', '587', 'email_settings', 1),
(35, 'smtp_user', 'arity.php@gmail.com', 'email_settings', 1),
(36, 'smtp_pass', 'ArityDotPhp@963!$', 'email_settings', 1),
(37, 'smtp', '', 'email_settings', 1),
(38, 'sendgrid_api_key', 'SG.2zvaIJPUQduWOc-nhFVKlw.ekIHiWuIZT3StAErI-6lsllOU0h', 'email_settings', 1),
(39, 'sendgrid', '', 'email_settings', 1);
...
CREATE TABLE `banners` (
  ...
  `title` varchar(200) NOT NULL,
  `image` varchar(200) NOT NULL,
  `type` enum('category','link') NOT NULL,
...
--
ALTER TABLE `appointment_extra`
  MODIFY `appo_extra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
